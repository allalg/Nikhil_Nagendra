...
export default function CaveWall() {
  ...
  useEffect(() => {
    ...
    const drawCharcoalMarkings = () => {
      ...
      drawWobblyText(albedoCtx, finalRoughnessCtx, "ACIS-X", p1X+32, 1000, H3);
      drawWobblyText(albedoCtx, finalRoughnessCtx, "Ambulance intelligence &", p1X+32, 1020, B);
      drawWobblyText(albedoCtx, finalRoughnessCtx, "IoT routing system", p1X+32, 1038, B);
      drawWobblyText(albedoCtx, finalRoughnessCtx, "healthcare chaos → scalable", p1X+14, 1060, IT);

      // P2: Ambulance IoT / ACIS extended
      const p2X = 365;
      ...
      // P5: Resume / Portfolio (or 5th project)
      drawLaptopIcon(albedoCtx, finalRoughnessCtx, p2X+9, 1155, 18);
      drawWobblyText(albedoCtx, finalRoughnessCtx, "THIS PORTFOLIO", p2X+32, 1150, H3);
      drawWobblyText(albedoCtx, finalRoughnessCtx, "A cave carved from", p2X+32, 1170, B);
      drawWobblyText(albedoCtx, finalRoughnessCtx, "React Three Fiber & Three.js", p2X+32, 1188, B);
      drawWobblyText(albedoCtx, finalRoughnessCtx, "probably overengineered.", p2X+14, 1210, IT);
      drawWobblyText(albedoCtx, finalRoughnessCtx, "still proud of it.", p2X+14, 1228, IT);
